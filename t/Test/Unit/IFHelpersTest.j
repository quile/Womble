...
@implementation IFHelpersTest : OJTestCase
...
- (void) testLength {
    ...
    var objjArray = [IFArray arrayFromObject:["foo", "bar", "baz"]];
...
- (void) testKeys {
    ...
    var oo = [IFDictionary dictionaryFromObject:{ "foo":"bong", "bar":"zab" }];
...
- (void) testArrayManipulation {
    var ja = ["a", "b"];
    var oja = [IFArray arrayFromObject:["a", "b"]];
...
- (void) testDictionaryManipulation {
    ...
    var ojd = [IFDictionary dictionaryFromObject:{ "a":"arse", "b":"bandit", }];
...
- (void) testIsArray {
    var ja = ["a", "b"];
    var oja = [IFArray arrayFromObject:["c", "d"]];
    var js = "I am a string";
    var ojs = @"I am a CP string";
    var jd = { "a":"foo", "b":"bar" };
    var ojd = [IFDictionary dictionaryFromObject:{ "a":"foo", "b":"bar" }];
