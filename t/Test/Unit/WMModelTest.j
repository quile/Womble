...
application = [WMTestApplication applicationInstanceWithName:"WMTest"];

@implementation _TestWMModel : WMModel
...
@implementation WMModelTest : OJTestCase
{
    WMModel model;
}

- (void) setUp {
    var modelData = [WMModelTest MODEL_DATA];
    model = [[_TestWMModel alloc] initWithModelData:modelData];
}
...
- (void) testDatabaseConfig {
    var dbc = [WMDB databaseInformation];
