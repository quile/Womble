...
@implementation IFArray : CPArray

+ (IFArray) arrayFromObject:(id)object {
    if (object && object.isa && [object isKindOfClass:CPArray] && [object isKindOfClass:IFArray]) {
        return  [[IFArray alloc] initWithArray:object];
    }
